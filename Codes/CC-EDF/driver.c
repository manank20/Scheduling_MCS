...
int main(int argc, char* argv[]){
    ...
    //initialize_frequencies - creates a frequency array with different frequencies.
    freq_struct* frequency = initialize_frequencies(task_file);
    ...
    edf_vd_scheduler(task_set, kernel, frequency, output_file);
