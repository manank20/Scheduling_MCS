...
*/
extern freq_struct* initialize_frequencies(FILE* fd);
...
/*
    ...
    Postconditions: 
        Output: {void}
*/
extern void edf_vd_scheduler(task_set_struct* task_set, kernel_struct* kernel, freq_struct* frequency, FILE* output_file);
