...
typedef struct{
    ...
    int job_number;
    double procrast_length[MAX_CRITICALITY_LEVELS];
}task;
...
/*
    ADT for the free run time list;
        It contains the slack time generated by the job, the deadline of the slack time (which is the priority of the node) and the next pointer.
*/
struct frt_list_struct{
    double free_run_time;
    double priority;
    struct frt_list_struct *next;
};

typedef struct frt_list_struct frt_list_struct;
